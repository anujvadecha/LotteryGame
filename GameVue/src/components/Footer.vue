...
<div class="row" style="background-color: white">
    <div v-if="!$q.platform.is.mobile" style="border: 1px solid black" class="col-3">
      <div class="row" >
      <div class="col" >
        <q-input @keydown.enter="claim_result()" label="Please enter barcode here" dense outlined v-model="barCodeNumber" style="border: 1px solid black" class="col-8" id="final_barcode"></q-input>
      </div>
